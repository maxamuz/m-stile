        ...
        <div class="row calculator-row">
            <div class="col">
                <div class="calculator-content">
                    ...
                    <p>В калькулятор заложена цена за полотно с установкой, площадь помещения и закладные под
                        ...
                        вставка закрывающая монтажный зазор между стеной и потолком). Обращаем ваше внимание, что калькулятор выдает только предварительну цену. После отправки данных с вами свяжется наш менеджер для согласования всех этапов работ и вызова замерщика. После этого определяется итоговая стоимость работ.</p><br>
